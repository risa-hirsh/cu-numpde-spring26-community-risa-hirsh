...
### 2026-03-27 (Fri): Community analysis proposal
  ...
  * Complete by editing [proposal.md](proposal.md) and pushing to your
    repository.
### 2026-03-30 (Mon): Sign up to present community analysis
  * [Sign up](https://github.com/cu-numpde/spring26/issues/1) for a short
    in-class/lab presentation on your community analysis.
### 2026-04-01 (Wed): Community analysis presentations
  * These should be 5-7 minutes long and will be followed by discussion.
  * Examine how the community works (e.g., who supports it, what sort of jobs
    are the maintainers doing, who are the users) as well as what motivates key
    design decisions and value judgments (e.g., choice of methods, choice of
    evaluation, testing, explicit or implicit cost and accuracy models).
  * These presentations should sketch your (maybe incomplete) ideas for
    contribution.
### 2026-04-08 (Wed): Contribution proposal
...
### 2026-04-20 (Mon): "Pull requests" submitted
...
### 2026-05-01 (Fri @ 1:30pm): Presentations from each group
  * How did you conceptualize your contribution?
  * What was the contribution (demo or otherwise show).
  * How did you evaluate and test the contribution?
...
-  * Integral equations (PDEs done differently)
...
- * Astrophysical comp hydrodynamics
